...
const buttonVariants = cva(
  'inline-flex items-center text-white justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-gray-300',
  {
    variants: {
      variant: {
          primary: 'bg-blue-500 text-red-50 dark:text-red-50 shadow hover:bg-blue-500/90 dark:bg-blue-900  dark:hover:bg-blue-900/90',
        default:
