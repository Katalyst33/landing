...
export default function Example() {
    return (
        ...
        <div className="mx-auto max-w-2xl lg:mx-0">
          <h2 className="text-3xl font-bold tracking-tight text-gray-700 sm:text-4xl">Our Team</h2>
        ...
        >
          {team.map((person) => (
            ...
            <h3 className="mt-6 text-lg font-bold leading-8 tracking-tight text-gray-800">{person.name}</h3>
            <LinkIcon size="1em" color="fill-blue-500" />
             ...
             <div className="flex mt-2 space-x-2">
               <a href="https://www.linkedin.com/in/azukaeme-brian-4329b0246/" className="text-gray-400 hover:text-gray-500">
                 <FaLinkedin className="w-5 h-5" />
               </a>
               <a href="https://twitter.com/i_amfury" className="text-gray-400 hover:text-gray-500">
                 <FaTwitter className="w-5 h-5" />
               </a>
               <a href="https://github.com/MadFury94" className="text-gray-400 hover:text-gray-500">
