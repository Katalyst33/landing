        ...
        <div className="px-6  sm:px-6  lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            ...
            Ready to Revolutionize Your Business?
              <br />
              Contact us today to discuss your project and see how we can collaborate to achieve your goals.

            </h2>
            <p className="mx-auto mt-6 max-w-xl text-lg leading-8 text-gray-700">
            Unlock the power of technology to propel your business forward. Whether you're looking to streamline operations, enhance productivity, or innovate your services, we're here to help.
            </p>
